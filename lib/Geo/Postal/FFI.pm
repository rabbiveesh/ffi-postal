...
Geo::Postal::FFI - FFI bindings for libpostal, an address parsing and deduping library
...
=head2 EXPANSION FUNCTIONS 

=head2 expansion_defaults
...
=head2 ADDRESS PARSING FUNCTIONS

=head2 parser_defaults
...
=head2 NEAR DUPE HASHING FUNCTIONS
...
=head2 PAIRWISE DEDUPING FUNCTIONS

=head2 duplicate_defaults
